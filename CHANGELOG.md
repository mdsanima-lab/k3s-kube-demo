...
## [0.1.0](https://github.com/mdsanima-lab/k3s-kube-demo/releases/tag/k3s-kube-demo-v0.1.0) (_2023-03-19_)

### 🤿 Enhancements

- Add simple home page ([673d1d3](https://github.com/mdsanima-lab/k3s-kube-demo/commit/673d1d3add872493b8ddeca03ed5b0afb18693bc))
- **k3s-hello-mdsanima:** Add Kubernetes schema for deployment ([c66bdf1](https://github.com/mdsanima-lab/k3s-kube-demo/commit/c66bdf12b4888ae9916b169b107b8f81707b65cd))
- **k3s-hello-mdsanima:** Add Kubernetes schema for ingress ([ad0c5cf](https://github.com/mdsanima-lab/k3s-kube-demo/commit/ad0c5cfe924c38bf9b9b8afca005e3c84ddad883))
- **k3s-hello-mdsanima:** Add Kubernetes schema for service ([3eab1db](https://github.com/mdsanima-lab/k3s-kube-demo/commit/3eab1db73acde5a7b526b068666053a9e5634e07))
- **k3s-hello-world:** Add Kubernetes schema for deployment ([0b286c0](https://github.com/mdsanima-lab/k3s-kube-demo/commit/0b286c08c41f4cb4b5269859c9823574a98fe083))
- **k3s-hello-world:** Add Kubernetes schema for ingress ([1f51131](https://github.com/mdsanima-lab/k3s-kube-demo/commit/1f51131a4630c4512c886a83c2563ee27cb233ac))
- **k3s-hello-world:** Add Kubernetes schema for service ([e125688](https://github.com/mdsanima-lab/k3s-kube-demo/commit/e1256882e3bcc11fc0fc0bee5df15e963eedfd1c))
...
- Add `.gitignore` setup for python and Node.js ([330a679](https://github.com/mdsanima-lab/k3s-kube-demo/commit/330a6793dde0f8ea5e0aecef46d262c5a8c63e00))
